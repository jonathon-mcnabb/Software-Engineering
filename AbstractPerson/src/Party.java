 ...
 * @author Cyndi Rader
 * 
 * Modified by Jonathon McNabb and Carter Pasqualini
 * 
...
public class Party {
	...
	public Party() {
		...
		people.add(new Gamer("Chucker Joe", "Esport Athlete", "Sonic and the Black Knight", 12));
		people.add(new Athlete("Big Tim", "Student", "Football", "The Hedgehogs"));
		people.add(new Nerd("Big Brain Brian", "Professor", "Angular Momentum 1.5", true));
		}
